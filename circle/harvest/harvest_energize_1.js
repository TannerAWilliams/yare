...
// Code Below - energize > 5 with break
...
function spirit_energize(spirit) {
    if(spirit.sight.friends.length > 0) {
        for(friendly_id of spirit.sight.friends) {
            ...
            if(distance(spirit, spirit_friend) <= 200 
            && spirit_friend.energy > 5 && spirit.energy != spirit.energy_capacity
            && spirit_friend.mark == 'harvest star' && spirit.mark == 'harvest star') {
